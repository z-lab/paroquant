...
class Qwen3Attention(nn.Module):
    def __init__(
        ...
        # Using custom RotateLinearInt4 instead of QKVParallelLinear
        ...
        # Updated get_rope call to match vllm 0.15.1 signature
...
class Qwen3Model(Qwen2Model):
    ...
    # Custom load_weights to handle RotateLinearInt4
