...
The optimized checkpoints will be saved to `./output/<model_name>`. To create a Hugging Face model with the checkpoints, use [`paroquant/cli/pseudo_quant.py`](../paroquant/cli/pseudo_quant.py) for pseudo quantization and [`paroquant/cli/real_quant.py`](../paroquant/cli/real_quant.py) for real quantization.
