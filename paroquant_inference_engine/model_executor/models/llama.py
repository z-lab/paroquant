...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        self.q_proj = self.q_proj = RotateLinearInt4(self.hidden_size, self.num_heads * self.head_dim, False, dtype=torch.half)
        self.k_proj = RotateLinearInt4(self.hidden_size, self.num_key_value_heads * self.head_dim, False, dtype=torch.half)
        self.v_proj = RotateLinearInt4(self.hidden_size, self.num_key_value_heads * self.head_dim, False, dtype=torch.half)
        self.o_proj = RotateLinearInt4(self.num_heads * self.head_dim, self.hidden_size, False, dtype=torch.half)
